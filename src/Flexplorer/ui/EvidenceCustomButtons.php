    ...
    public function __construct($source) {
        ...
        if (!empty($buttons)) {
            ...
            foreach ($buttons as $button) {
                $button['title'] = new \Ease\TWB5\LinkButton($button['url'],
                        $button['title'],
                ...
                $button['edit'] = new \Ease\TWB5\LinkButton('editor.php?evidence=custom-button&id=' . $button['id'],
                        new \Ease\TWB5\GlyphIcon('wrench'), 'warning');
                $button['delete'] = new \Ease\TWB5\LinkButton('delete.php?evidence=custom-button&action=delete&id=' . $button['id'],
